...
def test_dice_perfect_match():
    ...
    dice = dice_coefficient(pred, target, per_slice=False, per_frame=False, apply_softmax=False)
...
def test_dice_per_slice_and_frame():
    ...
    dice_slice = dice_coefficient(pred, target, per_slice=True, per_frame=False, apply_softmax=False)
    dice_frame = dice_coefficient(pred, target, per_slice=False, per_frame=True, apply_softmax=False)
    dice_global = dice_coefficient(pred, target, per_slice=False, per_frame=False, apply_softmax=False)
...
def test_dice_smooth_factor():
    ...
    dice = dice_coefficient(pred, target, per_slice=False, per_frame=False, smooth=1.0, apply_softmax=False)
