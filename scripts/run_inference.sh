#!/bin/bash
#SBATCH --job-name=nimosef_val
#SBATCH --output=/cluster/home/ja1659/logs/nimosef_val_%A_%a.out
#SBATCH --error=/cluster/home/ja1659/logs/nimosef_val_%A_%a.err
...
# Path to config file
config_file="${code_path}/configs/config_cluster_motion_v1_validation.json"
...
${singularity_img} /bin/bash -c "cd ${docker_code} && python -m nimosef.training.inference ${config_params}"
